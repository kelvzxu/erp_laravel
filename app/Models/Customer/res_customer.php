...
class res_customer extends Model
{
    ...
    protected $fillable = [
        ...
        'website','credit_limit','debit_limit','active','address','street','street2','zip',
        'city','state_id','country_id','email','phone','mobile','industry_id','sales',
        'payment_terms','note','user_id','receivable_account','logo','journal',
    ];
