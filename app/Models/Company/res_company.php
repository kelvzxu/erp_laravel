...
{
    protected $fillable = [
        'company_name','display_name','currency_id','parent_id','vat','email',
        'Phone', 'website','icon','photo','company_registry','address','street',
        'street2','zip','city','state_id','country_id','partner_latitude',
        'partner_longitude','social_twitter','social_facebook','social_youtube',
        'social_instagram','social_github','social_linkedin','tax_id','bank_account',
        'bank_account2',
    ];
