...
<head>
	...
	<!-- Magnific Popup -->
	<link rel="stylesheet" href="{{asset('ecommerce/css/magnific-popup.min.css')}}">
	<!-- Font Awesome -->
	<link rel="stylesheet" href="{{asset('ecommerce/css/font-awesome.css')}}">
	<!-- Fancybox -->
	<link rel="stylesheet" href="{{asset('ecommerce/css/jquery.fancybox.min.css')}}">
	<!-- Themify Icons -->
	<link rel="stylesheet" href="{{asset('ecommerce/css/themify-icons.css')}}">
	<!-- Nice Select CSS -->
	<link rel="stylesheet" href="{{asset('ecommerce/css/niceselect.css')}}">
	<!-- Animate CSS -->
	<link rel="stylesheet" href="{{asset('ecommerce/css/animate.css')}}">
	<!-- Flex Slider CSS -->
	<link rel="stylesheet" href="{{asset('ecommerce/css/flex-slider.min.css')}}">
	<!-- Owl Carousel -->
	...
	<!-- Eshop StyleSheet -->
	<link rel="stylesheet" href="{{asset('ecommerce/css/reset.css')}}">
...
<body class="js">
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-5 col-md-12 col-12">
						...
						<div class="top-left">
							<ul class="list-main">
								<li><i class="ti-headphone-alt"></i> +062 (061) 801-582</li>
								<li><i class="ti-email"></i> care@kltech-intl.technology</li>
							</ul>
						</div>
						<!--/ End Top Left -->
					</div>
	...
	<script src="{{asset('ecommerce/js/jquery-migrate-3.0.0.js')}}"></script>
	...
	<!-- Owl Carousel JS -->
	<script src="{{asset('ecommerce/js/owl-carousel.js')}}"></script>
	<!-- Magnific Popup JS -->
	<script src="{{asset('ecommerce/js/magnific-popup.js')}}"></script>
	<!-- Waypoints JS -->
	<script src="{{asset('ecommerce/js/waypoints.min.js')}}"></script>
	<!-- Countdown JS -->
	<script src="{{asset('ecommerce/js/finalcountdown.min.js')}}"></script>
	<!-- Nice Select JS -->
	<script src="{{asset('ecommerce/js/nicesellect.js')}}"></script>
	<!-- Flex Slider JS -->
	<script src="{{asset('ecommerce/js/flex-slider.js')}}"></script>
	<!-- ScrollUp JS -->
	<script src="{{asset('ecommerce/js/scrollup.js')}}"></script>
	<!-- Onepage Nav JS -->
	<script src="{{asset('ecommerce/js/onepage-nav.min.js')}}"></script>
	<!-- Easing JS -->
	<script src="{{asset('ecommerce/js/easing.js')}}"></script>
	<!-- Active JS -->
