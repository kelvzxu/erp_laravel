    ...
    <div class="o_control_panel">
        <div>
            <ol class="breadcrumb" role="navigation">
                <li class="breadcrumb-item" accesskey="b"><a href="{{route('return-invoice.index')}}">Report Return Invoice</a></li>
            </ol>
                ...
                <nav class="o_cp_pager" role="search" aria-label="Pager">
                    <div class="o_pager o_hidden">
                        <span class="o_pager_counter">
                            <span class="o_pager_value">{{$return_inv->total()}}</span> / <span class="o_pager_limit">{{$return_inv->perPage()}}</span>
                        </span>
