<div class="row">
    <div class="col-sm-4 mt-4">
        ...
        <div class="wrap-input200">
            <label>Client</label>
            <input type="text" id="client" class="input200" value="{{ $invoice->customer->name }}"  name="client" readonly>
    ...
    @foreach($invoice->products as $data)
        <tr>
            ...
            <td class="table-price">
                <input type="text" style="border:none" class="form-control" value="Rp. {{ number_format($data->price)}}" name="price[]">
            </td>
            <td class="table-qty">
