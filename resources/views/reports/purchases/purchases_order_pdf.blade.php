...
@section('title')
<title>Report Purchases ({{$monthName}}-{{$year}})</title>
@endsection
@section('css')
<style>
...
@endsection
@section('content')
    <h3><b><u>Report Purchases ({{$monthName}}-{{$year}})</u></b></h3>
    @if($data->count())
        ...
        <table class="table">
            <thead class="table table-sm text-center">
                <tr>
                    ...
                    <th class="align-middle" scope="col">Vendor</th>
                    <th class="align-middle" scope="col">Order Date</th>
                    <th class="align-middle" scope="col">Representative</th>
