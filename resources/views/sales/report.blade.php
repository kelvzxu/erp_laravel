...
@section('title','Report - Sales Order')
@section('css')
    ...
    <div class="o_control_panel">
        <div>
            <ol class="breadcrumb" role="navigation">
                <li class="breadcrumb-item" accesskey="b"><a href="{{route('sales_orders.report')}}">Sales Report</a></li>
                    ...
                    <div class="btn-group">
                        <div class="btn-group o_dropdown">
                            ...
                            <div class="dropdown-menu o_dropdown_menu" role="menu">
                                <a href="{{route('sales_orders.print')}}" class="dropdown-item undefined"><i class="fa fa-print"></i>&nbsp;Print Report</a>     
                            </div>
                        </div>
            ...
            <div class="card mb-3 bg-midnight-bloom">
                <div class="widget-content text-white">
                    <div class="col-6 pull-left text-left">
                        <div class="widget-heading"><h3>Total Sale This Month</h3></div>
                    </div>
            ...
            <div class="card mb-3 bg-danger">
                <div class="widget-content text-white">
                    <div class="col-8 pull-left text-left">
                        <div class="widget-heading"><h3>Sales To Be Invoice </h3></div>
                    </div>
...
<script>
    ...
    $('a#report_invoice').addClass('mm-active');
