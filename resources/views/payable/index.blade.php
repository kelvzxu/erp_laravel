    ...
    <div class="o_control_panel">
        <div>
            <ol class="breadcrumb" role="navigation">
                <li class="breadcrumb-item" accesskey="b"><a href="{{route('PayableAccount.index')}}">Payable Account</a></li>
            </ol>
        ...
        <div>
            <div class="o_cp_left">
                <div class="o_cp_buttons" role="toolbar" aria-label="Control panel toolbar">
                    <div>
                        <a href="{{route('PayableAccount.Print')}}" class="btn btn-primary"><i class="fa fa-print"></i> Print</a>
                    </div>
                </div>
            </div>
                ...
                <nav class="o_cp_pager" role="search" aria-label="Pager">
                    <div class="o_pager">
                        <span class="o_pager_counter">
                            <span class="o_pager_value">{{$Payable->total()}}</span> / <span class="o_pager_limit">{{$Payable->perPage()}}</span>
                        </span>
        ...
        <div class="panel-body ml-2">
            ...
            <div class="o_nocontent_help">
                <p class="o_view_nocontent_smiling_face">
                    ...
                    Congratulation You dont Have Payments Bills To Vendors
                </p>
            </div>
            @endif
        </div>
