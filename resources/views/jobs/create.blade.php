        ...
        <div class="page-breadcrumb">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-10">
                        <div class="card">
                            <form action="{{route('jobs.store')}}" method="post" class="form-horizontal">
                                @csrf
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="jobs_name" class="form-control" id="fname" placeholder="Enter a jobs name">
                                        </div>
                                    </div>
                                    <div class="form-group row">
