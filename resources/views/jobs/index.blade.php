        ...
        <div>
            <div class="o_cp_left">
                <div class="o_cp_buttons" role="toolbar" aria-label="Control panel toolbar">
                    <div>
                        <a type="button" class="btn btn-primary o-kanban-button-new" accesskey="c" href="{{route('jobs.create')}}">
                            Create
                        </a>
                    ...
                    <div>
                        <div class="btn-group o_dropdown">
                            <select
                                ...
                                <option value="jobs_name">Name</option>
                ...
                <nav class="o_cp_pager" role="search" aria-label="Pager">
                    <div class="o_pager o_hidden">
                        <span class="o_pager_counter">
                            <span class="o_pager_value">{{$jobs->total()}}</span> / <span class="o_pager_limit">{{$jobs->perPage()}}</span>
                        </span>
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td >
                                <a href="{{route('jobs.edit',$data->id)}}" class="btn btn-sm btn-success"><i class="fa fa-edit">  Edit</i></a>
                            </td>
                        </tr>
                    </tbody>
                    @endforeach
