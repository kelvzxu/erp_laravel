                ...
                <nav class="o_cp_pager" role="search" aria-label="Pager">
                    <div class="o_pager o_hidden">
                        <span class="o_pager_counter">
                            <span class="o_pager_value">{{$return_po->total()}}</span> / <span class="o_pager_limit">{{$return_po->perPage()}}</span>
                        </span>
                ...
                <table class="table table-striped">
                    <thead class="table table-sm">
                        <tr>
                            ...
                            <th scope="col" colspan="2">Created By</th>
                        </tr>
                    </thead>
                    @foreach($return_po as $data)
                    <tbody>
                        <tr>
                            ...
                            <td class="text-right">
                                ...
                                <!-- <a href="{{ route('return-po.show', $data->purchase_no) }}" class="btn btn-primary btn-sm">View</a> -->
                            </td>
                        </tr>
                    </tbody>
                    @endforeach
