...
@endsection
@section('content') 
<form action="{{ route('return-po.store') }}" method="post" enctype="multipart/form-data">
    @csrf
    <div class="app-page-title bg-white">
        <div class="o_control_panel">
            <div>
                <ol class="breadcrumb" role="navigation">
                    <li class="breadcrumb-item" accesskey="b"><a href="{{route('receipt.index')}}">Delivery Products</a></li>
                    <li class="breadcrumb-item" accesskey="c"><a href="{{ URL::previous() }}">{{$receipt->receipt_no}}</a></li>
                ...
                <div class="o_cp_left">
                    <div class="o_cp_buttons" role="toolbar" aria-label="Control panel toolbar">
                        <div>
                            ...
                            <a href="{{ URL::previous() }}" class="btn btn-secondary mby-2">Discard</a>
                        </div>
                    </div>
                </div>
