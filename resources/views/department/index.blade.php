...
@section('title','Human Resource - Department')
@section('css')
        ...
        <div>
            <div class="o_cp_left">
                <div class="o_cp_buttons" role="toolbar" aria-label="Control panel toolbar">
                    <div>
                        <a type="button" class="btn btn-primary o-kanban-button-new" accesskey="c" href="{{route('department.create')}}">
                            Create
                        </a>
                ...
                <nav class="o_cp_pager" role="search" aria-label="Pager">
                    <div class="o_pager o_hidden">
                        <span class="o_pager_counter">
                            <span class="o_pager_value">{{$department->total()}}</span> / <span class="o_pager_limit">{{$department->perPage()}}</span>
                        </span>
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td >{{$data->manager->employee_name}}</td>
                            <td >
                                <a href="{{route('department.edit',$data->id)}}" class="btn btn-sm btn-success"><i class="fa fa-edit">  Edit</i></a>
                            </td>
                        </tr>
                    </tbody>
                    @endforeach
