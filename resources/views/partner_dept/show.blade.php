    ...
    <div class="o_control_panel">
        <div>
            <ol class="breadcrumb" role="navigation">
                ...
                <li class="breadcrumb-item active">{{$partnerdebt[0]->partner_name}}</li>
            </ol>
                ...
                <nav class="o_cp_pager" role="search" aria-label="Pager">
                    <div class="o_pager">
                        <span class="o_pager_counter">
                            <span class="o_pager_value">{{$partnerdebt->total()}}</span> / <span class="o_pager_limit">{{$partnerdebt->perPage()}}</span>
                        </span>
        ...
        <div class="panel-body ml-2">
            ...
            <div class="o_nocontent_help">
                <p class="o_view_nocontent_smiling_face">
                    ...
                    Congratulation You dont Have Payment Bill To vendors
                </p>
            </div>
            @endif
        </div>
