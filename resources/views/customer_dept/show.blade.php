    ...
    <div class="o_control_panel">
        <div>
            <ol class="breadcrumb" role="navigation">
                ...
                <li class="breadcrumb-item active">{{$customerdebt[0]->name}}</li>
            </ol>
                ...
                <nav class="o_cp_pager" role="search" aria-label="Pager">
                    <div class="o_pager">
                        <span class="o_pager_counter">
                            <span class="o_pager_value">{{$customerdebt->total()}}</span> / <span class="o_pager_limit">{{$customerdebt->perPage()}}</span>
                        </span>
