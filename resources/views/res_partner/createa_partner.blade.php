            ...
            <div class="row">
                <div class="col-sm-9">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="name" id="name" placeholder="Vendor Name" class="form-control @error('name') is-invalid @enderror" value="{{ old('name') }}"  autocomplete="name" autofocus>
                        </div>
                    </div>
                    <div class="form-group row">
