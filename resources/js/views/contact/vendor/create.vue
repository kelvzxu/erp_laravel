            ...
            <div class="o_form_sheet_bg">
              <div class="clearfix position-relative o_form_sheet">
                ...
                <div class="oe_title">
                  ...
                  >
                    <div class="custom-control custom-radio o_radio_item" aria-atomic="true">
                      <b-form-radio
                        ...
                        name="some-radios"
                        value="individual"
                        :checked="state.title == 'individual'"
                        @click="onChangeIndividual"
                      >
                        <label
                  ...
                  <div class="o_row">
                    <div class="o_field_widget o_field_many2one" v-if="state.title == 'individual'">
                      ...
                      <table class="o_group o_inner_group">
                        <tbody>
                          <tr>
                            ...
                            <td style="width: 100%;">
                              <select class="o_input o_field_widget" v-model="state.address">
                                <option
                                ...
                                <tr>
                                  ...
                                  <td style="width: 100%;">
                                    ...
                                    >
                                      <div class="o_input_dropdown">
                                        <select
                                          v-model="state.receivable_account"
                                          class="o_input ui-autocomplete-input"
                                        >
                                          <option
...
export default {
  ...
  methods: {
    ...
    prepare_parent_address() {
      axios
        .post(`/api/vendor/search/${state.parent_id}`)
        .then((response) => {
    ...
    submit($e) {
      axios
        .post("/api/vendor/store", this.state)
        .then((response) => {
