      ...
      <div class="tab-pane active" id="notebook_page_511">
        ...
        >
          ...
          >
            ...
            >
            <img v-if="row.parent_id != null && row.parent.logo != null" class="o_kanban_image_inner_pic" v-bind:alt="row.parent.display_name" v-bind:src="'/uploads/Vendors/'+row.parent.logo">
            ...
            <div
              v-else
              class="o_kanban_image_fill_left"
              v-bind:style="{ 'background-image': 'url(/uploads/Vendors/'+ row.logo+')' }"
            >
            <img v-if="row.parent_id != null && row.parent.logo != null" class="o_kanban_image_inner_pic" v-bind:alt="row.parent.display_name" v-bind:src="'/uploads/Vendors/'+row.parent.logo">
            <img v-if="row.parent_id != null && row.parent.logo == null" class="o_kanban_image_inner_pic" v-bind:alt="row.parent.display_name" v-bind:src="'/images/icons/avatar.png'">
            </div>
...
export default {
  ...
  methods: {
    ...
    show(row) {
      this.$router.push({ name: "vendor_edit", params: { id: btoa(row.id) } });
    },
  },
  computed: {
    filterdata() {
