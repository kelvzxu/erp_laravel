            ...
            <div>
              <ol class="breadcrumb" role="navigation">
                <li class="breadcrumb-item" accesskey="b">
                  <router-link class="text-primary" :to="{ name:'purchases_index' }">Requests for Quotation</router-link>
                </li>
                    ...
                    <div class="col-6">
                      <table class="o_group o_inner_group">
                        <tbody>
                          <tr>
                            <td class="o_td_label">
                              <label class="o_form_label o_required_modifier">Vendors</label>
                            </td>
                            <td style="width: 100%;">
                              <select
                          ...
                          <div class="col-6">
                            <table class="o_group o_inner_group">
                              <tbody>
                                ...
                                <tr>
                                  <td class="o_td_label">
                                    <label class="o_form_label" for="o_field_input_6367">Merchandises</label>
                                  </td>
                                  <td style="width: 100%;">
                                    <div
                                    ...
                                    >
                                      ...
                                      >
                                        <option
                                          ...
                                          :select="row.user_id == state.merchandise"
                                          :key="row.id"
                                          :value="row.id"
                          ...
                          <div class="col-6">
                            <table class="o_group o_inner_group">
                              <tbody>
                                <tr>
                                  <td colspan="2" style="width: 100%;">
                                    <div class="o_horizontal_separator">Receipts</div>
                                  </td>
                                </tr>
                                <tr>
                                  <td class="o_td_label">
...
export default {
  ...
  methods: {
    ...
    fetchUser() {
      ...
      axios
        ...
        .then((response) => {
          ...
          this.state.merchandise = this.result.id;
        })
        .catch((error) => console.error(error));
    },
    onChange(product) {
      ...
      axios
        ...
        .then((response) => {
          ...
          this.state.products.splice(product.index, 1, {
            ...
            price: this.result.cost,
            qty: 1,
            product_uom_qty: 1,
            product_uom: this.result.uom_po.id,
            product_uom_category: this.result.uom_po.category_id,
            taxes: this.result.tax_id,
            price_subtotal: this.result.cost,
    ...
    compute_qty(product){
      ...
      console.log(product.product_uom_qty)
      this.compute_total(product)
    },
    ...
    submit($e) {
      axios
        .post("/api/purchase/store", this.state)
        .then((response) => {
