          ...
          <div>
            <ol class="breadcrumb" role="navigation">
              <li class="breadcrumb-item active">
                <router-link class="text-primary" :to="{ name:'purchases_analysis' }">Purchases Analysis</router-link>
              </li>
            </ol>
...
//     //LIST TAHUN DARI 2010 SAMPAI TAHUN SAAT INI UNTUK DILOOPING DI FILTER TAG
  ...
  methods: {
    getChartData(payload) {
      axios
        .get(`/api/purchase/analysis?month=${payload.month}&year=${payload.year}`)
        .then((response) => {
