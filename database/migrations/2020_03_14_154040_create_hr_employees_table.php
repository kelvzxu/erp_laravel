...
class CreateHrEmployeesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('hr_employees', function (Blueprint $table) {
            ...
            $table->integer('user_id',200)->nullable()->index();
            $table->boolean('active')->nullable();
            $table->integer('country_id',200)->index()->nullable();
            ...
            $table->integer('country_of_birth',200)->nullable()->index();
            $table->date('birthday')->nullable();
            $table->string('ssnid')->nullable();
            $table->string('identification_id')->nullable();
            $table->string('passport_id')->nullable();
            $table->string('bank_account_id',200)->index()->nullable();
            ...
            $table->integer('department_id',200)->index()->nullable();
            $table->integer('job_id',200)->index()->nullable();
