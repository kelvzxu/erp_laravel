...
class CreateAccountJournalsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('account_journals', function (Blueprint $table) {
            ...
            $table->integer('default_credit_account_id',200)->index()->nullable();
            $table->integer('default_debit_account_id',200)->index()->nullable();
            $table->boolean('restrict_mode_hash_table')->nullable();
            $table->integer('sequence_id',200)->index()->nullable();
            $table->integer('refund_sequence_id',200)->index()->nullable();
            ...
            $table->integer('profit_account_id',200)->index()->nullable();
            $table->integer('loss_account_id',200)->index()->nullable();
            $table->integer('bank_account_id',200)->index()->nullable();
            $table->string('bank_statements_source')->nullable();
            $table->string('post_at')->nullable();
            $table->integer('alias_id',200)->index()->nullable();
            $table->integer('secure_sequence_id',200)->index()->nullable();
            $table->integer('show_on_dashboard',200)->index()->nullable();
            $table->timestamps();
            $table->softDeletes();
        });
    }
